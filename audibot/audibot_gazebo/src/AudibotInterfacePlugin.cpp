...
void AudibotInterfacePlugin::feedbackTimerCallback(const ros::TimerEvent& event) {
  ...
  pub_gear_state_.publish(gear_state_msg);
    ...
    odom_msg.header.frame_id = "front_axle";
    odom_msg.header.stamp = event.current_real;
    odom_msg.twist.twist = twist_;
    odom_msg.pose.pose.position.x = front_pose_.Pos().X();
    odom_msg.pose.pose.position.y = front_pose_.Pos().Y();
    odom_msg.pose.pose.position.z = front_pose_.Pos().Z();
    odom_msg.pose.pose.orientation.x = front_pose_.Rot().X();
    odom_msg.pose.pose.orientation.y = front_pose_.Rot().Y();
    odom_msg.pose.pose.orientation.z = front_pose_.Rot().Z();
    odom_msg.pose.pose.orientation.w = front_pose_.Rot().W();
